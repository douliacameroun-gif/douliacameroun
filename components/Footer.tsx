      ...
      <div className="max-w-7xl mx-auto px-6 flex flex-wrap gap-12 lg:gap-16 mb-16 justify-between">
        <div className="max-w-xs space-y-6">
          ...
          <div className="flex gap-4">
            ...
            <a href="https://www.facebook.com/profile.php?id=61583620293750" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg border border-white/10 flex items-center justify-center hover:border-lime hover:text-lime transition-all bg-white/5">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a href="https://www.linkedin.com/company/doulia/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg border border-white/10 flex items-center justify-center hover:border-lime hover:text-lime transition-all bg-white/5">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col gap-2">
             ...
             <p className="text-white/70 font-tech tracking-tight text-sm font-bold underline decoration-lime/30">(+237) 6 73 04 31 27</p>
